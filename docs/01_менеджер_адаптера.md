...
*   **Конфигурация:** Получает все необходимые настройки из [Конфигурация Адаптера и Клиента (AdapterConfig, ClientConfiguration)](02_конфигурация_адаптера.md).
...
*   **[Конфигурация Адаптера и Клиента (AdapterConfig, ClientConfiguration)](02_конфигурация_адаптера.md):** Отсюда он берет все настройки – куда подключаться, как себя вести и т.д.
*   **`ResultStorage`:** Внутренний компонент для временного хранения данных о тестах, фикстурах, шагах до их отправки.
*   **[Запись Результатов (TestItWriter)](04_запись_результатов.md) / [Запись Результатов по HTTP (HttpWriter)](08_запись_результатов.md):** Компоненты, ответственные за финальную подготовку и отправку данных через `ApiClient`.
...
**Далее:** [Глава 2: Конфигурация Адаптера и Клиента (AdapterConfig, ClientConfiguration)](02_конфигурация_адаптера.md)
