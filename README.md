...
1. Find the sync-storage version for your adapter release: check out the release tag and look for the `SYNC_STORAGE_VERSION` value in SyncStorageRunner.kt. 
